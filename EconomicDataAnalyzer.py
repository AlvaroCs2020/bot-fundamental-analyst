...
class EconomicDataAnalyzer:
    ...
    def __load_inputs(self, json_path: str, system_prompt_path: str, complementary_path: str):
        ...
        system_prompt = system_prompt.replace("USD", self.currency2).replace("EUR", self.currency1)
    ...
    def get_analysis_result(self):
        name_of_pair = f"{self.currency1}{self.currency2}"
        ...
        self.__save_text_to_file(path=result_path, content=str(analysis))
        return output
